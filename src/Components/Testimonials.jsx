...
const testimonials = [
  ...
  },
  {
    ...
    avatar:
      "https://plus.unsplash.com/premium_photo-1705018501151-4045c97658a3?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
  },
  {
    name: "Mark Johnson",
    testimonial:
...
const Testimonials = () => {
  return (
    <Box sx={{ py: 5, backgroundColor: "#fdf8ea", paddingBottom: "5rem" }}>
      <Divider
        sx={{ my: 4, borderColor: "#495E57", width: "80%", mx: "auto" }}
      />
      <Container>
        <Typography
          variant="h4"
